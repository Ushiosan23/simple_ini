...
public final class SectionContentUtils {
	 ...
	 * @return Returns a section object info
	 */
	 ...
	 * @return Returns a entry info content or {@code null} if the content is not valid
	 */
	public static @Nullable Map.Entry<String, String> getEntryInfo(final @NotNull String content) {
		...
		// Return the result
		return Containers.entry(key, value);
	}
	...
	private static @Unmodifiable @NotNull Map<String, String> getSectionAttributes(final @NotNull String content) {
		...
		Map<String, String> result = Containers.mutableMapOf();
